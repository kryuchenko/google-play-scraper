...
// A full AllCountries sweep is ~150 requests; at the default 600ms throttle that
// is roughly 90s. Probing is active and anonymous, so keep the throttle gentle
