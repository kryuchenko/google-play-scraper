...
func main() {
	...
	// The loop body below and the OnShard* callbacks all run on this goroutine:
	// CatalogSeq yields serially and calls the callbacks as it does, so the
	// counters and maps need no locking of their own.
	var (
		w       *bufio.Writer
		file    *os.File
		total   int
