...
// String renders the generation for a human: the date it was published, the
// run within that date, and how many shards it holds. Use ID for anything that
// has to be matched or stored.
